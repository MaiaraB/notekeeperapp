...
import static com.example.notekeeperapp.NoteKeeperDatabaseContract.*;
...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatch) {
            case COURSES:
                // vnd.android.cursor.dir/vnd.com.example.notekeeperapp.provider.courses
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatch) {
            case NOTES:
                ...
                // content://com.example.notekeeperapp.provider/notes/1
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatch) {
            ...
            case COURSES_ROW:
                ...
                rowSelection = CourseInfoEntry._ID + " = ?";
                rowSelectionArgs = new String[] {Long.toString(rowId)};
                cursor = db.query(CourseInfoEntry.TABLE_NAME, projection, rowSelection, rowSelectionArgs, null, null, null);
                break;
            case NOTES_ROW:
                rowId = ContentUris.parseId(uri);
                rowSelection = NoteInfoEntry._ID + " = ?";
